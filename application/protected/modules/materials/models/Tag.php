...
/**
 * This is the model class for table "ml_tag".
 *
 * The followings are the available columns in table 'ml_tag':
 * @property string $id
...
class Tag extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'contents' => array(self::MANY_MANY, 'Content', 'ml_content_has_ml_tag(ml_tag_id, ml_content_id)'),
		);
	}
